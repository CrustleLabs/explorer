  ...
  return (
    <Box maxWidth="lg" mx="auto" px={3}>
      ...
      <Alert severity="info" sx={{mb: 4}}>
        ...
        The Intention Explorer supports multiple verification levels to help
        users identify legitimate tokens and addresses. This page explains how
        to get your tokens and addresses verified through the official channels.
      </Alert>
      ...
      <Paper sx={{p: 4, mb: 4}}>
        ...
        <Typography variant="body1" mb={2}>
          To get your token verified on Intention Explorer, you must be added to
      ...
      <Paper sx={{p: 4, mb: 4}}>
        ...
        <Typography variant="body1" mb={2}>
          Address verification helps users identify legitimate project addresses
          and avoid scams. Address verification requests are handled directly
          through the explorer's GitHub repository.
        </Typography>
      ...
      <Paper sx={{p: 4}}>
        ...
        <Alert severity="error" sx={{mb: 3}}>
          ...
          verification process. All verification processes are free and handled
          through official GitHub repositories.
        </Alert>
        ...
        <Typography variant="body1" mb={2}>
          Address verification requests are typically reviewed within 1-2 weeks.
          Token verification through Panora follows their community review
          process.
        </Typography>
